...
class Transactions extends CI_Controller
{
    ...
    public function cancelinvoice()
    {
        ...
        if($invoice_result['status'] == 'canceled'){ 
            ...
            $emp_salary = $invoices_commission ? $invoices_commission[0]->salary : 0;
            
            $sum_of_products = array_sum(array_column($invoices_commission,'subtotal'));
            
            $discount_amount_commission_calculate = $sum_of_products > 0?  ($invoice_result['discount'] / $sum_of_products) * 100 : 0 ; 
